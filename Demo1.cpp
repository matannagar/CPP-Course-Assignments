...
int main()
{
	...
	cout << board.cities.at(City::Kinshasa).level << endl;
	...
	cout << board.cities.at(City::MexicoCity).level << endl;
	board[City::HoChiMinhCity] = 1; // put 1 red disease cube in HoChiMinhCity
	cout << board.cities.at(City::HoChiMinhCity).level << endl;
	board[City::Chicago] = 1; // put 1 blue disease cube in Chicago
	cout << board.cities.at(City::Chicago).level << endl;
	...
	cout << player.myCards.size() << endl;

	// /* build action */

	player.build(); // legal action: you build a research station in Atlanta.
	cout << boolalpha;
	cout << board.cities.at(City::Atlanta).research_facility << endl;		 // print true
	cout << player.board.cities.at(City::Atlanta).research_facility << endl; //print true
	...
	cout << "level: " << board.cities.at(City::Kinshasa).level << endl;
	...
	cout << "is cure found: " << board.cities.at(City::LosAngeles).cure_found << endl;
	...
	cout << "level: " << board.cities.at(City::MexicoCity).level << endl;
