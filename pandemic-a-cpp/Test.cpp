...
TEST_CASE("BASIC TESTS")
{
    ...
    Dispatcher di(board, City::NewYork);
    FieldDoctor fd(board, City::NewYork);
    GeneSplicer gs(board, City::NewYork);
    Virologist vi(board, City::NewYork);
    Researcher re(board, City::NewYork);
    Scientist sc(board, City::NewYork, 5);
    Medic me(board, City::NewYork);

    vector<Player> players = {oe, di, fd, gs, vi, re, sc, me};
    // //////////////////////////////////////////////
    SUBCASE("Take Cards")
    {
        int counter = 0;
    ...
    SUBCASE("Build")
    {
        vector<Player> players_build = {di, fd, gs, vi, re, sc, me};
        for (auto player : players_build)
        {
    ...
    SUBCASE("Treat")
    {
        vector<Player> players_treat = {oe, di, fd, gs, vi, re, sc};
        for (auto player : players_treat)
        {
    ...
    {
        vector<Player> players_find_cure = {
