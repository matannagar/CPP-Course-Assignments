...
int main()
{
  ...
  NumberWithUnits b{300, "km"}; // 300 meters
  ...
  // // sample_input >> a;
  // NumberWithUnits c{700, "kg"};
  // NumberWithUnits d{700, "kg"};
  // bool flag = (c!=d);
  // cout<<"is it :" <<flag <<endl;
  // cout << c << endl;                                // Prints "700[kg]"
  // cout << (c -= NumberWithUnits{1, "ton"}) << endl; // prints "1700[kg]"
  // cout << c << endl;                                // Prints "1700[kg]". Note that a has changed.
